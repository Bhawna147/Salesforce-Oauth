...
# django_salesforce_oauth
SCOPES = "id profile email address phone full chatter_api openid custom_permissions content user_registration_api sfap_api api refresh_token offline_access"
